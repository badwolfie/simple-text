/* simple-tab-bar.c generated by valac 0.28.0, the Vala compiler
 * generated from simple-tab-bar.vala, do not modify */
...
typedef struct _SimpleTabBarPrivate SimpleTabBarPrivate;
...
struct _SimpleTabBar {
	GtkBox parent_instance;
	SimpleTabBarPrivate * priv;
	gint tab_num;
};

struct _SimpleTabBarClass {
	GtkBoxClass parent_class;
};

struct _SimpleTabBarPrivate {
	gint tab_extra_num;
	GtkStack* stack;
	GtkBox* extra_box;
...
static gpointer simple_tab_bar_parent_class = NULL;

GType simple_tab_bar_get_type (void) G_GNUC_CONST;
GType simple_tab_get_type (void) G_GNUC_CONST;
#define SIMPLE_TAB_BAR_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), TYPE_SIMPLE_TAB_BAR, SimpleTabBarPrivate))
enum  {
	SIMPLE_TAB_BAR_DUMMY_PROPERTY,
	SIMPLE_TAB_BAR_EXTRA_TABS,
	SIMPLE_TAB_BAR_TABS
};
...
static void simple_tab_bar_create_widgets (SimpleTabBar* self);
static gboolean __lambda16_ (SimpleTabBar* self, GdkEventButton* event);
...
static void _simple_tab_bar_close_page_simple_tab_close_clicked (SimpleTab* _sender, SimpleTab* tab, gpointer self);
void simple_tab_bar_switch_page (SimpleTabBar* self, SimpleTab* tab);
static void _simple_tab_bar_switch_page_simple_tab_tab_clicked (SimpleTab* _sender, SimpleTab* tab, gpointer self);
static void simple_tab_bar_refresh_marked (SimpleTabBar* self);
...
static void __lambda17_ (SimpleTabBar* self, SimpleTab* entry);
void simple_tab_refresh_title (SimpleTab* self);
static void ___lambda17__gfunc (gconstpointer data, gpointer self);
static void __lambda18_ (SimpleTabBar* self, SimpleTab* entry);
static void ___lambda18__gfunc (gconstpointer data, gpointer self);
GList* simple_tab_bar_get_extra_tabs (SimpleTabBar* self);
GList* simple_tab_bar_get_tabs (SimpleTabBar* self);
...
static void simple_tab_bar_finalize (GObject* obj);
static void _vala_simple_tab_bar_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec);
...
SimpleTabBar* simple_tab_bar_construct (GType object_type) {
	SimpleTabBar * self = NULL;
	self = (SimpleTabBar*) g_object_new (object_type, NULL);
	gtk_orientable_set_orientation ((GtkOrientable*) self, GTK_ORIENTATION_HORIZONTAL);
	gtk_box_set_spacing ((GtkBox*) self, 0);
	simple_tab_bar_create_widgets (self);
	return self;
}


SimpleTabBar* simple_tab_bar_new (void) {
	return simple_tab_bar_construct (TYPE_SIMPLE_TAB_BAR);
}
...
static gboolean ___lambda16__gtk_widget_button_press_event (GtkWidget* _sender, GdkEventButton* event, gpointer self) {
	gboolean result;
	result = __lambda16_ ((SimpleTabBar*) self, event);
	return result;
}
...
static void simple_tab_bar_create_widgets (SimpleTabBar* self) {
	...
	g_signal_connect_object ((GtkWidget*) _tmp5_, "button-press-event", (GCallback) ___lambda16__gtk_widget_button_press_event, self, 0);
...
static void _simple_tab_bar_close_page_simple_tab_close_clicked (SimpleTab* _sender, SimpleTab* tab, gpointer self) {
	simple_tab_bar_close_page ((SimpleTabBar*) self, tab);
}


static void _simple_tab_bar_switch_page_simple_tab_tab_clicked (SimpleTab* _sender, SimpleTab* tab, gpointer self) {
	simple_tab_bar_switch_page ((SimpleTabBar*) self, tab);
}
...
void simple_tab_bar_add_page (SimpleTabBar* self, SimpleTab* tab, gboolean new_page) {
	...
	_tmp13_ = tab;
	g_signal_connect_object (_tmp13_, "close-clicked", (GCallback) _simple_tab_bar_close_page_simple_tab_close_clicked, self, 0);
	_tmp14_ = tab;
	g_signal_connect_object (_tmp14_, "tab-clicked", (GCallback) _simple_tab_bar_switch_page_simple_tab_tab_clicked, self, 0);
	_tmp15_ = new_page;
	if (_tmp15_) {
		SimpleTab* _tmp16_ = NULL;
		SimpleTab* _tmp17_ = NULL;
		_tmp16_ = tab;
		simple_tab_bar_switch_page (self, _tmp16_);
		simple_tab_bar_refresh_marked (self);
		_tmp17_ = tab;
		simple_tab_mark_title (_tmp17_);
	}
}
...
void simple_tab_bar_switch_page (SimpleTabBar* self, SimpleTab* tab) {
	...
	_tmp6_ = tab;
	_tmp7_ = simple_tab_get_tab_widget (_tmp6_);
	_tmp8_ = _tmp7_;
	gtk_stack_set_visible_child (_tmp5_, (GtkWidget*) _tmp8_);
	simple_tab_bar_refresh_marked (self);
	_tmp9_ = tab;
	simple_tab_mark_title (_tmp9_);
	_tmp10_ = tab;
	g_signal_emit_by_name (self, "page-switched", _tmp10_);
}


SimpleTab* simple_tab_bar_get_current_page (SimpleTabBar* self, GtkWidget* current_doc) {
	SimpleTab* result = NULL;
		...
		SimpleTab* _tmp16_ = NULL;
		{
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					_tmp9_ = simple_tab_get_tab_widget ((SimpleTab*) _tmp8_);
					_tmp10_ = _tmp9_;
					_tmp11_ = current_doc;
					if (G_TYPE_CHECK_INSTANCE_CAST (_tmp10_, gtk_widget_get_type (), GtkWidget) == _tmp11_) {
						...
						_tmp15_ = _g_object_ref0 ((SimpleTab*) _tmp14_);
		...
		if (_tmp16_ == NULL) {
			{
				...
				i = 0;
				{
					...
					while (TRUE) {
						...
						_tmp25_ = simple_tab_get_tab_widget ((SimpleTab*) _tmp24_);
						_tmp26_ = _tmp25_;
						_tmp27_ = current_doc;
	...
	if (_tmp2_ != (-1)) {
		...
		if (_tmp3_ == ((SimpleTab*) _tmp6_)) {
			...
			if (_tmp7_ > 0) {
				...
				_tmp10_ = _tmp9_->data;
				simple_tab_bar_switch_page (self, (SimpleTab*) _tmp10_);
			} else {
				GList* _tmp11_ = NULL;
				GList* _tmp12_ = NULL;
				...
				simple_tab_bar_switch_page (self, (SimpleTab*) _tmp13_);
			}
		} else {
			SimpleTab* tab = NULL;
			GList* _tmp14_ = NULL;
			...
			_tmp19_ = _g_object_ref0 ((SimpleTab*) _tmp18_);
			tab = _tmp19_;
			_tmp20_ = tab;
			simple_tab_bar_switch_page (self, _tmp20_);
		...
		if (_tmp23_ != (-1)) {
			...
			if (_tmp24_ == ((SimpleTab*) _tmp27_)) {
				...
				simple_tab_bar_switch_page (self, (SimpleTab*) _tmp30_);
			} else {
				SimpleTab* tab = NULL;
				GList* _tmp31_ = NULL;
				GList* _tmp32_ = NULL;
				SimpleTab* _tmp33_ = NULL;
				gint _tmp34_ = 0;
				gconstpointer _tmp35_ = NULL;
				SimpleTab* _tmp36_ = NULL;
				SimpleTab* _tmp37_ = NULL;
				...
				_tmp36_ = _g_object_ref0 ((SimpleTab*) _tmp35_);
				tab = _tmp36_;
				_tmp37_ = tab;
				simple_tab_bar_switch_page (self, _tmp37_);
				_g_object_unref0 (tab);
			}
		}
	}
...
void simple_tab_bar_close_page (SimpleTabBar* self, SimpleTab* tab) {
	...
	if (_tmp0_ != NULL) {
		...
		gint _tmp5_ = 0;
		_tmp1_ = tab;
		_tmp2_ = simple_tab_bar_get_page_num (self, _tmp1_);
		page_num = _tmp2_;
...
static void __lambda17_ (SimpleTabBar* self, SimpleTab* entry) {
	...
	_tmp0_ = entry;
	simple_tab_refresh_title (G_TYPE_CHECK_INSTANCE_TYPE (_tmp0_, TYPE_SIMPLE_TAB) ? ((SimpleTab*) _tmp0_) : NULL);
}


static void ___lambda17__gfunc (gconstpointer data, gpointer self) {
	__lambda17_ ((SimpleTabBar*) self, (SimpleTab*) data);
}
...
static void ___lambda18__gfunc (gconstpointer data, gpointer self) {
	__lambda18_ ((SimpleTabBar*) self, (SimpleTab*) data);
}
...
static void simple_tab_bar_class_init (SimpleTabBarClass * klass) {
	simple_tab_bar_parent_class = g_type_class_peek_parent (klass);
	g_type_class_add_private (klass, sizeof (SimpleTabBarPrivate));
	G_OBJECT_CLASS (klass)->get_property = _vala_simple_tab_bar_get_property;
	G_OBJECT_CLASS (klass)->finalize = simple_tab_bar_finalize;
	g_object_class_install_property (G_OBJECT_CLASS (klass), SIMPLE_TAB_BAR_EXTRA_TABS, g_param_spec_pointer ("extra-tabs", "extra-tabs", "extra-tabs", G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	g_object_class_install_property (G_OBJECT_CLASS (klass), SIMPLE_TAB_BAR_TABS, g_param_spec_pointer ("tabs", "tabs", "tabs", G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE));
	g_signal_new ("page_closed", TYPE_SIMPLE_TAB_BAR, G_SIGNAL_RUN_LAST, 0, NULL, NULL, g_cclosure_user_marshal_VOID__OBJECT_INT, G_TYPE_NONE, 2, TYPE_SIMPLE_TAB, G_TYPE_INT);
	g_signal_new ("page_switched", TYPE_SIMPLE_TAB_BAR, G_SIGNAL_RUN_LAST, 0, NULL, NULL, g_cclosure_marshal_VOID__OBJECT, G_TYPE_NONE, 1, TYPE_SIMPLE_TAB);
}


static void simple_tab_bar_instance_init (SimpleTabBar * self) {
	self->priv = SIMPLE_TAB_BAR_GET_PRIVATE (self);
...
static void simple_tab_bar_finalize (GObject* obj) {
	SimpleTabBar * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, TYPE_SIMPLE_TAB_BAR, SimpleTabBar);
	_g_object_unref0 (self->priv->stack);
	_g_object_unref0 (self->priv->extra_box);
	_g_object_unref0 (self->priv->extra_menu);
	_g_object_unref0 (self->priv->extra_popup);
	__g_list_free__g_object_unref0_0 (self->priv->_extra_tabs);
	__g_list_free__g_object_unref0_0 (self->priv->_tabs);
	G_OBJECT_CLASS (simple_tab_bar_parent_class)->finalize (obj);
}


GType simple_tab_bar_get_type (void) {
	static volatile gsize simple_tab_bar_type_id__volatile = 0;
	if (g_once_init_enter (&simple_tab_bar_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (SimpleTabBarClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) simple_tab_bar_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (SimpleTabBar), 0, (GInstanceInitFunc) simple_tab_bar_instance_init, NULL };
		GType simple_tab_bar_type_id;
		simple_tab_bar_type_id = g_type_register_static (gtk_box_get_type (), "SimpleTabBar", &g_define_type_info, 0);
		g_once_init_leave (&simple_tab_bar_type_id__volatile, simple_tab_bar_type_id);
	}
	return simple_tab_bar_type_id__volatile;
}


static void _vala_simple_tab_bar_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec) {
	SimpleTabBar * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (object, TYPE_SIMPLE_TAB_BAR, SimpleTabBar);
	switch (property_id) {
		case SIMPLE_TAB_BAR_EXTRA_TABS:
		g_value_set_pointer (value, simple_tab_bar_get_extra_tabs (self));
		break;
		case SIMPLE_TAB_BAR_TABS:
		g_value_set_pointer (value, simple_tab_bar_get_tabs (self));
		break;
		default:
