...
static void main_window_create_widgets (MainWindow* self) {
	...
	GtkBox* vbox = NULL;
	GtkBox* _tmp51_ = NULL;
	GtkSearchBar* _tmp52_ = NULL;
	SimpleTabBar* _tmp53_ = NULL;
	GtkStack* _tmp54_ = NULL;
	SimpleStatusbar* _tmp55_ = NULL;
	VteTerminal* _tmp56_ = NULL;
	GtkPaned* pane = NULL;
	GtkPaned* _tmp57_ = NULL;
	...
	vbox = _tmp51_;
	_tmp52_ = self->priv->search_bar;
	gtk_box_pack_start (vbox, (GtkWidget*) _tmp52_, FALSE, TRUE, (guint) 0);
	_tmp53_ = self->priv->tab_bar;
	gtk_box_pack_start (vbox, (GtkWidget*) _tmp53_, FALSE, TRUE, (guint) 7);
	_tmp54_ = self->priv->documents;
	gtk_box_pack_start (vbox, (GtkWidget*) _tmp54_, TRUE, TRUE, (guint) 0);
	_tmp55_ = self->priv->status;
	gtk_box_pack_start (vbox, (GtkWidget*) _tmp55_, FALSE, TRUE, (guint) 0);
	g_object_set ((GtkWidget*) vbox, "height-request", 400, NULL);
	gtk_widget_show ((GtkWidget*) vbox);
	_tmp56_ = (VteTerminal*) vte_terminal_new ();
	g_object_ref_sink (_tmp56_);
	_g_object_unref0 (self->priv->terminal);
	self->priv->terminal = _tmp56_;
	_tmp57_ = (GtkPaned*) gtk_paned_new (GTK_ORIENTATION_VERTICAL);
	g_object_ref_sink (_tmp57_);
	pane = _tmp57_;
	gtk_paned_pack1 (pane, (GtkWidget*) vbox, FALSE, FALSE);
	_tmp58_ = self->priv->terminal;
	gtk_paned_pack2 (pane, (GtkWidget*) _tmp58_, TRUE, TRUE);
